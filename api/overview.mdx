...
[Web SDK](/web-sdk/overview); o seu backend cria as verificações e recebe as decisões pela API.
...
de curta duração, como descrito em [segurança](/web-sdk/security).

<Columns cols={2}>
  <Card title="Autenticação" icon="key-round" href="/api/authentication">
    O formato da chave, o ciclo de vida e a rotação sem downtime.
  </Card>
  <Card title="Criar verificações" icon="user-check" href="/api/verifications">
