...
[chave de API](/api/autenticacao) e recebe a `sdkUrl` da verificação. Não há criação pelo
...
- Entregue-a ao seu front-end e monte o widget. Veja a [visão geral da API](/api/visao-geral) e o
...
em [segurança](/web-sdk/seguranca). O registro tem verificação de posse:
