...
Documentação canônica: https://docs.legitimuz.com. Leia /quickstart, /web-sdk/opcoes,
/web-sdk/eventos, /web-sdk/erros e /web-sdk/seguranca antes de escrever código. O índice
...
- A emissão da `sdkUrl` no seu backend: veja a [visão geral da API](/api/visao-geral).
- A allowlist de origens da integração, que precisa incluir a página onde o widget vai rodar.

<Card title="Servidor MCP" icon="plug" href="/ia/mcp">
