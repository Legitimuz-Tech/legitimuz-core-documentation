...
<ParamField path="sdkUrl" type="string" required>
  ...
  em log nem enviar para ferramentas de analytics. Veja [segurança](/web-sdk/seguranca).
</ParamField>
...
<ParamField path="onEvent" type="(event) => void">
  Eventos de progresso da sessão. O catálogo completo está em [eventos](/web-sdk/eventos).
</ParamField>
...
<ParamField path="onComplete" type="(result) => void">
  ...
  aprovado nem concluído com sucesso. Veja [eventos](/web-sdk/eventos#desfecho-do-fluxo).
</ParamField>
...
<ParamField path="onError" type="(error) => void">
  ...
  `console.error`. Veja [tratamento de erros](/web-sdk/erros).
</ParamField>
